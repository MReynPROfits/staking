...
const tokenContract = '0xD663DF5DDb0AcE7a2176862b27AE75B5F72EfE9f'
  ...
  if (typeof window.ethereum !== 'undefined') {
    ...
    if ((typeof window.ethereum !== 'undefined', chainid === '0x38'|| '0x61')) {
     ...
     // dappStatus.innerHTML = 'Live!'
      ...
      connectButton.innerHTML = 'Please switch to Binance Smartchain'
    }
  } else {
...
async function unstake() {
  if (typeof window.ethereum !== 'undefined') {
    ...
    try {
      ...
      preLoader.style.display = 'none'
      notifyMM.style.display = 'none'
      alert('You have unstaked the tokens Successfully!')
    } catch (error) {
      preLoader.style.display = 'none'
      notifyMM.style.display = 'none'
      document.body.style.overflow = 'auto'
...
const testAbi = [
   ...
   },
   {
      ...
      "name":"Contract_SetUp_01__Fees_on_Buy",
      "outputs":[
   ...
   },
   {
      ...
      "name":"Contract_SetUp_02__Fees_on_Sell",
      "outputs":[
   ...
   },
   {
      ...
      "name":"Contract_SetUp_03__Wallet_Limits",
      "outputs":[
   ...
   },
   {
      "inputs":[
         {
            "internalType":"uint256",
            "name":"Early_Buy_Timer_in_Seconds",
            "type":"uint256"
         },
         {
            "internalType":"bool",
      ...
      "name":"Contract_SetUp_04__Bot_Protection",
      "outputs":[
   ...
   },
   {
      ...
      "name":"Contract_SetUp_06__Blacklist_Bots",
      "outputs":[
   ...
   },
   {
      ...
      "name":"Options__Deactivate_Launch_Mode",
      "outputs":[
